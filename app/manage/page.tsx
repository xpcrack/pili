          ...
          <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            <div className="space-y-2">
              ...
              <textarea
                ...
                rows={8}
                placeholder={`CYxVq9uQzBw8pH4NLq9259jm7JxfjL11hhiFLboczdZ1:yry#7
JB1YjJJv1ggL8ouz6MpeSFsn2vDp7iXnJgDmCKQCdpoY:yry#8
Ay9wnuZCRTceZJuRpGZnuwYZuWdsviM4cMiCwFoSQiPH:冷静#1
0xeb89055e16ae1c1e42ad6770a7344ff5c7b4f31d:冷静#2`}
              ...
              <p className="text-xs text-zinc-500">
                推荐格式: <code>地址:人物名#地址别名</code>。例如 <code>...:yry#7</code> 会创建人物
                yry，并把这条地址记为 <code>#7</code>。`0x` 开头会识别为 BSC，其它地址识别为 Solana。
              </p>
            </div>
