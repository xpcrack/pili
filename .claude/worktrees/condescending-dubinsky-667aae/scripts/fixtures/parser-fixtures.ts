...
export const fixtureAddresses = {
  ...
  duck: '0x0000000000000000000000000000000000003001',
...
export const parserFixtureCases: ParserFixtureCase[] = [
  ...
  {
    name: 'grouped-buy-stable-multileg',
    chain: 'bsc',
    trackedAddress: fixtureAddresses.trackedA,
    transactions: [
      {
        txHash: '0xgrouped-buy-stable-multileg',
        txTime: '1710000001500',
        iType: '2',
        symbol: 'USDC',
        amount: '0.17',
        tokenContractAddress: fixtureAddresses.usdc,
        from: [{ address: fixtureAddresses.trackedA, amount: '0.17' }],
        to: [{ address: fixtureAddresses.counterparty, amount: '0.17' }],
        txStatus: 'success',
      },
      {
        txHash: '0xgrouped-buy-stable-multileg',
        txTime: '1710000001501',
        iType: '2',
        symbol: 'USDC',
        amount: '13.1599',
        tokenContractAddress: fixtureAddresses.usdc,
        from: [{ address: fixtureAddresses.trackedA, amount: '13.1599' }],
        to: [{ address: fixtureAddresses.router, amount: '13.1599' }],
        txStatus: 'success',
      },
      {
        txHash: '0xgrouped-buy-stable-multileg',
        txTime: '1710000001502',
        iType: '2',
        symbol: 'USDC',
        amount: '11.6701',
        tokenContractAddress: fixtureAddresses.usdc,
        from: [{ address: fixtureAddresses.trackedA, amount: '11.6701' }],
        to: [{ address: fixtureAddresses.router, amount: '11.6701' }],
        txStatus: 'success',
      },
      {
        txHash: '0xgrouped-buy-stable-multileg',
        txTime: '1710000001503',
        iType: '2',
        symbol: 'DUCK',
        amount: '67554.76',
        tokenContractAddress: fixtureAddresses.duck,
        from: [{ address: fixtureAddresses.router, amount: '67554.76' }],
        to: [{ address: fixtureAddresses.trackedA, amount: '67554.76' }],
        txStatus: 'success',
      },
    ],
    expected: {
      ...
      quoteToken: 'USDC',
      quoteAmount: '25',
      tradeAmountUsdAtTx: 25,
      titleIncludes: '买入资产',
      contentIncludes: '买入 67554.76 DUCK，花费 25 USDC',
      uncertainFrom: false,
      feedCount: 1,
      detailFetches: 0,
      filterDecision: 'visible',
